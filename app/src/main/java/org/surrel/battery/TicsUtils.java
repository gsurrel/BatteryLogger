...
public class TicsUtils {
    ...
    // raw -> degC
    private static final PressureUnitConverter converter_degC =
    ...
    // raw -> K
    private static final PressureUnitConverter converter_degK =
            new PressureUnitConverter() {
                @Override
                public float convert(float value) {
                    return (value / 10F) + 273.15F;
                }
            };

    // raw -> degF
    private static final PressureUnitConverter converter_degF =
            new PressureUnitConverter() {
                @Override
                public float convert(float value) {
                    return (value / 10F) * 1.8F + 32F;
                }
            };

    private static final PressureUnitConverter[] converters = {
            converter_degC,
            converter_degK,
            converter_degF,
    };
    ...
    public static class UnitParameters {
        ...
        private final TypedArray params;
    ...
    public static UnitParameters getUnitParameters(Context context, int unit) {
        ...
        TypedArray params = res.obtainTypedArray(param_ids.getResourceId(unit, 0));
