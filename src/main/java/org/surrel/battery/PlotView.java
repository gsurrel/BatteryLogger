...
public class PlotView extends View {
    ...
    private int secondary_color = 0xffa0a0a0;
    ...
    private void init(Context context) {
        ...
        selection_drawable = context.getResources().getDrawable(R.drawable.plotter_selection);
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (value_sub_step > 0) {
            paint.setColor(sub_tics_color);
            float sub_min = (float) (Math.floor(
        ...
        if (value_main_step > 0) {
            paint.setColor(main_tics_color);
            float main_min = (float) (Math.floor(
